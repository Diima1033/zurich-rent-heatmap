...
export default function Sidebar({ rooms, onChange, mobile, searchData = [], onSelectResult }: SidebarProps) {
  ...
  // Mobile: search + room filter at bottom
  if (mobile) {
    return (
      <div
        style={{
      ...
      >
        {/* Suchleiste */}
        <div ref={searchRef} className="relative px-4 pt-3">
          <input
            type="text"
            value={query}
            placeholder="Gemeinde oder Quartier suchen…"
        ...
        {/* Zimmerzahl */}
        <div className="flex items-center gap-2 px-4 py-3 overflow-x-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
